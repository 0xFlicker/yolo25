...
import { AllClients, baseClient, getChainClient, sepoliaClient } from "./viem";
...
> = {
  ...
  [META_DEX_ORIGIN.AERODROME]: {
    chainId: base.id,
    ourStaker: "0x8570ad7739962ab0433585cd02875a49a49b237c",
    ourToken: "0xcc02E40f5dEc0fB68157fb67335505DfBd0A4f84",
