...
<<<<<<< Updated upstream:packages/contracts/veStuxNet.sol
    bool internal isLocked = false;
=======
    bool public locked = false;
>>>>>>> Stashed changes:packages/contracts/lib/aerodrome-finance/contracts/VotingEscrow.sol
...
=======
        if (locked) revert NotManagedOrNormalNFT();
>>>>>>> Stashed changes:packages/contracts/lib/aerodrome-finance/contracts/VotingEscrow.sol
